    ...
    <button class="btn btn-primary d-md-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasMenu" aria-controls="offcanvasMenu">
        ...
        <div class="col-12 col-md-9 content">
            <div class="header">
                ...
                <br/>
                <p class="text-muted">Here’s a quick overview of your restaurant's editing offers.</p>
            </div>
    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('offers.update', $offer->id) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="title" class="form-control" value="{{ $offer->food_name }}">
            </div>

            <div class="form-group">
                <label for="discount">Discount</label>
                <input type="number" name="discount" class="form-control" value="{{ $offer->discount }}">
            </div>

            <div class="form-group">
                <label for="link">Add Text</label>
                <input type="text" name="link" class="form-control" value="{{ $offer->text }}">
            </div>

            <div class="form-group">
                <label for="images">Image</label>
                <input type="file" name="image" class="form-control">
                <img src="{{url('public/images/'.$offer['image'])}}" width="50" height="50">
            </div>

            <button type="submit" class="btn btn-primary btn-custom">Update Offer</button>
        </form>
    </div>
</div>
</x-app-layout>
