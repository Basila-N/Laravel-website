        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>${{ $item->price }}</td>
                    <td><img src="{{url('public/images/'.$item['image'])}}" width="50" height="50"></td>
                    <td>
                    <a href="{{ route('menus.edit', $item->id) }}" class="btn btn-warning btn-sm">Edit</a>
                    <a href="{{ route('menus.delete', $item->id) }}" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">Delete</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
